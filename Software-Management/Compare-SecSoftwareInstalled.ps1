 function Compare-SecSoftwareInstalled
 {
    ...
    <#
    .Synopsis
        Compares the baseline of installed software to the newly-generated list of currently installed software.
    .Description
        Called by the Get function, compares the baseline of installed software to the newly-generated list of currently installed software, then provides an exception report based on the differences
