...
#>
    ...
    $Password = Get-Credential "$($Domain)\$($UserName)"
    $PasswordPtr = [System.Runtime.InteropServices.Marshal]::SecureStringToCoTaskMemUnicode($Password.Password)
    ...
    Write-Verbose '"Honey hash" injected into LSASS successfully! Use Mimikatz to confirm.'
}
